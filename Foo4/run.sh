...
echo "opt -stats -load $SCLIB -load $AUGLIB -break-constgeps -lowerswitch -mergereturn -reg2mem -aug-struct -ins-func=$2 -update-func=$3 $1.bc -o $1-nogeps.bc"
opt -stats -load $SCLIB -load $AUGLIB -break-constgeps -lowerswitch -mergereturn -reg2mem -aug-struct -ins-func=$2 -update-func=$3 $1.bc -o $1-nogeps.bc
